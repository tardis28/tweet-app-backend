...
public class TweetAppControllerTests {
	...
	String responseJson = "{\"id\":\"id\",\"username\":\"admin\",\"password\":\"admin\",\"confirmPassword\":null,\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null}";

	String loginResponseJson = "{\"user\":{\"id\":\"id\",\"username\":\"admin\",\"password\":\"admin\",\"confirmPassword\":null,\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null},\"loginStatus\":\"success\"}";
...
// TODO Auto-generated catch block
	...
	public void registerationTest() throws Exception {
		...
		String requestJson = "{\"id\":\"id\",\"username\":\"admin\",\"password\":null,\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null}";
	...
	public void getAllUsersPositiveFlow() throws Exception {
		...
		String expectedJson = "[{\"id\":\"id\",\"username\":\"admin\",\"password\":\"admin\",\"confirmPassword\":null,\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null}]";

		when(userServiceMock.getAllUsers()).thenReturn(user1List);
		MockHttpServletResponse response = mockMvc.perform(get(url).accept(MediaType.APPLICATION_JSON)).andReturn()
				.getResponse();
	...
	public void getUsersTweetsPositiveFlow() throws Exception {
		...
		String expectedJson = "[{\"id\":\"1\",\"tweetName\":\"Demo Tweet\",\"postDate\":null,\"likes\":190,\"user\":null,\"replies\":null,\"tweetTag\":null}]";
	...
	public void postTweetPositiveTest() throws Exception {
		...
		String responseJson = "{\"id\":\"1\",\"tweetName\":\"Demo Tweet\",\"postDate\":null,\"likes\":98,\"user\":{\"id\":null,\"username\":null,\"password\":\"admin\",\"confirmPassword\":null,\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null},\"replies\":null,\"tweetTag\":\"DemoTweetTag\"}";
	...
	public void getAllTweetsPositiveFlow() throws Exception {
		...
		String expectedJson = "[{\"id\":\"1\",\"tweetName\":\"Demo Tweet\",\"postDate\":null,\"likes\":98,\"user\":{\"id\":null,\"username\":null,\"password\":\"admin\",\"confirmPassword\":null,\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null},\"replies\":null,\"tweetTag\":\"DemoTweetTag\"}]";
